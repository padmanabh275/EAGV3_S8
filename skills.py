...
_TOOL_CATALOG = {
    ...
    # Exposed for corpus_indexer (mcp_server.py already implements these).
    "list_dir": {
        "name": "list_dir",
        "description": "List files and directories under a path inside the sandbox.",
        "input_schema": {
            "type": "object",
    ...
    "index_document": {
        "name": "index_document",
        "description": "Chunk a sandbox file and write chunks into Memory as searchable facts.",
        "input_schema": {
            "type": "object",
            "properties": {
                "path": {"type": "string"},
